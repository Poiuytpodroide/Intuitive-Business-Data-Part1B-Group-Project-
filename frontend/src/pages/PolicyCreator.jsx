      ...
      <div className="flex gap-4 p-4 overflow-hidden flex-1">
        ...
        <aside className="w-72 bg-white border border-gray-200 rounded shadow-sm flex flex-col overflow-y-auto">
          <div className="px-4 py-4 border-b border-gray-200 bg-gray-50">
            <h3 className="m-0 text-sm font-bold text-gray-900">Templates</h3>
          </div>
      ...
      >
        <div className="px-4 py-3 border-b border-gray-200 bg-gray-50 flex-shrink-0">
          <button
            ...
            onClick={() => setBlocksPanelExpanded(!blocksPanelExpanded)}
          >
          ...
          <div className="p-4 flex gap-8 overflow-x-auto">
            <div className="flex-shrink-0">
              ...
              <div className="flex flex-col gap-2">
                <div className="px-3.5 py-2.5 bg-gray-50 border border-gray-300 rounded text-sm text-gray-900 cursor-grab hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm transition-all active:cursor-grabbing">Input Block</div>
              </div>
            </div>

            <div className="flex-shrink-0">
              <h4 className="m-0 mb-3 text-xs font-bold text-gray-600 uppercase tracking-wide">Components</h4>
              <div className="flex flex-col gap-2">
                <div className="px-3.5 py-2.5 bg-gray-50 border border-gray-300 rounded text-sm text-gray-900 cursor-grab hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm transition-all active:cursor-grabbing">Process Block</div>
                <div className="px-3.5 py-2.5 bg-gray-50 border border-gray-300 rounded text-sm text-gray-900 cursor-grab hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm transition-all active:cursor-grabbing">Decision Block</div>
              </div>
            </div>
            ...
            <div className="flex-shrink-0">
              ...
              <div className="flex flex-col gap-2">
                <div className="px-3.5 py-2.5 bg-gray-50 border border-gray-300 rounded text-sm text-gray-900 cursor-grab hover:bg-gray-100 hover:border-gray-400 hover:shadow-sm transition-all active:cursor-grabbing">Output Block</div>
              </div>
            </div>
          </div>
        )}
